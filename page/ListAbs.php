								...
								<div class="card">
									<div class="card-header">
										<div class="d-flex align-items-center">
											<h4 class="card-title"> Liste des Absents</h4>
                                    ...
                                    <div class="table-responsive">
											...
											<thead>
													...
													<?php while ($result=mysql_fetch_assoc($trait)) { ?>
														<tr>
															...
															<div class="form-button-action">
																<a href="DemandeE.php?matri=<?php echo( $result["matricule"] ); ?>&&num=<?php echo( $result["numero"] ); ?>">
																	<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Attribuer un D.E">
																		<i class="fab fa-telegram"></i>Demande d'Explication
																	</button>
																</a>
															</td>
												...
												<?php	if(($cat=='Secretaire')){?>
														<a href="Imprimer_Absent.php?cadre=CUA">
												...
												<?php	}else{
														if(($cat=='VOIRIE')){?>
															<a href="Imprimer_Absent.php?cadre=VOIRIE">
																<button type="submit" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Imprimer">
																	<i class="fas fa-print"></i>  Imprimer
																</button>
															</a>
												<?php		}else{?>
															<a href="Imprimer_Absent.php">
																<button type="submit" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Imprimer">
																	<i class="fas fa-print"></i>  Imprimer
																</button>
															</a>
